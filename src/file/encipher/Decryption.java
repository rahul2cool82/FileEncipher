...
public class Decryption extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        code=DatatypeConverter.parseBase64Binary(str);
        //code=str.getBytes();
        //System.out.println(bytesToString(code));
        byte[] decrypted = decrypt(code);
        //System.out.println("Decrypting Bytes: " + bytesToString(decrypted));
        //System.out.println("Decrypted String: " + new String(decrypted));
        fileKey=new String(decrypted);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            byte[] fkey=DatatypeConverter.parseHexBinary(fileKey);
            secKey= new SecretKeySpec(fkey, 0, fkey.length, "AES");
            //System.out.println(secKey);
            Decrypto decpt=new Decrypto(secKey, ipfile, opfile, ext);
        }
        catch(Exception e){
